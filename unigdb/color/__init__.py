...
# import unigdb.memoize

disable_colors = unigdb.config.set('self.disable_colors', bool(os.environ.get('UNIGDB_DISABLE_COLORS')), 'whether to color the output or not')
